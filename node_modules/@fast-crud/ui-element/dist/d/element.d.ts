import { TextAreaCI, UiInterface, DialogCI, TableColumnCI, Icons, IconCI, TableCI, SelectCI, MessageCI, NotificationCI, MessageBoxCI, InputCI, OptionCI, FormWrapperCI, FormItemCI, DrawerCI, CheckboxCI, RadioCI, RadioGroupCI, TagCI, CheckboxGroupCI, CascaderCI, SwitchCI, InputPasswordCI, InputGroupCI, DatePickerCI, TimePickerCI, DropdownCI, DropdownMenuCI, DropdownItemCI, ImageGroupCI, ImageCI, ProgressCI, LoadingCI, UploadCI, TreeSelectCI, TabsCI, TabPaneCI, CollapseCI, CollapseItemCI, ButtonCI, PaginationCI, DividerCI, FormCI, PopoverCI, TooltipCI, InputNumberCI, BadgeCI, CollapseTransitionCI, ButtonGroupCI, ColCI, RowCI, CardCI, RadioButtonCI } from "@fast-crud/ui-interface";
export type ElementUiProvider = {
    Notification: any;
    Message: any;
    MessageBox: any;
};
export declare class Element implements UiInterface {
