...
import { _ as D } from "./index-e3d54c21.mjs";
const N = g({
  name: "FsCopyable",
  props: {
    modelValue: {
...
function z(e, n, a, u, s, l) {
  ...
  return t(), r("div", {
    ...
    e.modelValue != null && e.copyButton.show !== !1 ? (t(), r("div", O, [
      i((t(), C(M(e.tagName), V({ class: "pointer" }, e.copyButton), {
        default: _(() => [
...
//# sourceMappingURL=fs-copyable-711d2eb6.mjs.map
