import { h as Jt, defineComponent as ke, ref as G, computed as Ie, resolveComponent as Kt, openBlock as Dt, createBlock as Rt, resolveDynamicComponent as te, mergeProps as Bt, withCtx as At, createElementVNode as W, createVNode as Ct, withDirectives as _t, vShow as kt, toDisplayString as ze, createElementBlock as Le, Fragment as He, renderList as Ye, normalizeClass as Pe } from "vue";
import { useUi as We, useI18n as Xe } from "@fast-crud/fast-crud";
import { _ as Ue } from "./index-e3d54c21.mjs";
import "lodash-es";
/*!
 * Cropper.js v1.5.13
...
function ve(a) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? ee(Object(i), !0).forEach(function(e) {
      $e(a, e, i[e]);
...
var Ot = typeof window < "u" && typeof window.document < "u", V = Ot ? window : {}, Ft = Ot && V.document.documentElement ? "ontouchstart" in V.document.documentElement : !1, Gt = Ot ? "PointerEvent" in V : !1, D = "cropper", qt = "all", we = "crop", ye = "move", xe = "zoom", K = "e", tt = "w", rt = "s", q = "n", pt = "ne", ut = "nw", ft = "se", dt = "sw", Yt = "".concat(D, "-crop"), ae = "".concat(D, "-disabled"), I = "".concat(D, "-hidden"), re = "".concat(D, "-hide"), Qe = "".concat(D, "-invisible"), Tt = "".concat(D, "-modal"), Pt = "".concat(D, "-move"), mt = "".concat(D, "Action"), Et = "".concat(D, "Preview"), Zt = "crop", De = "move", Ce = "none", Wt = "crop", Xt = "cropend", Ut = "cropmove", jt = "cropstart", oe = "dblclick", Je = Ft ? "touchstart" : "mousedown", Ke = Ft ? "touchmove" : "mousemove", ti = Ft ? "touchend touchcancel" : "mouseup", ne = Gt ? "pointerdown" : Je, se = Gt ? "pointermove" : Ke, he = Gt ? "pointerup pointercancel" : ti, ce = "ready", le = "resize", pe = "wheel", Vt = "zoom", ue = "image/jpeg", ei = /^e|w|s|n|se|sw|ne|nw|all|crop|move|zoom$/, ii = /^data:/, ai = /^data:image\/jpeg;base64,/, ri = /^img|canvas$/i, Ee = 200, Me = 100, fe = {
  ...
  crop: null,
  zoom: null
}, oi = '<div class="cropper-container" touch-action="none"><div class="cropper-wrap-box"><div class="cropper-canvas"></div></div><div class="cropper-drag-box"></div><div class="cropper-crop-box"><span class="cropper-view-box"></span><span class="cropper-dashed dashed-h"></span><span class="cropper-dashed dashed-v"></span><span class="cropper-center"></span><span class="cropper-face"></span><span class="cropper-line line-e" data-cropper-action="e"></span><span class="cropper-line line-n" data-cropper-action="n"></span><span class="cropper-line line-w" data-cropper-action="w"></span><span class="cropper-line line-s" data-cropper-action="s"></span><span class="cropper-point point-e" data-cropper-action="e"></span><span class="cropper-point point-n" data-cropper-action="n"></span><span class="cropper-point point-w" data-cropper-action="w"></span><span class="cropper-point point-s" data-cropper-action="s"></span><span class="cropper-point point-ne" data-cropper-action="ne"></span><span class="cropper-point point-nw" data-cropper-action="nw"></span><span class="cropper-point point-sw" data-cropper-action="sw"></span><span class="cropper-point point-se" data-cropper-action="se"></span></div></div>', ni = Number.isNaN || V.isNaN;
function v(a) {
...
function bi(a, t, i, e) {
  var n = t.aspectRatio, r = t.naturalWidth, o = t.naturalHeight, s = t.rotate, p = s === void 0 ? 0 : s, l = t.scaleX, h = l === void 0 ? 1 : l, c = t.scaleY, u = c === void 0 ? 1 : c, g = i.aspectRatio, m = i.naturalWidth, y = i.naturalHeight, b = e.fillColor, E = b === void 0 ? "transparent" : b, T = e.imageSmoothingEnabled, x = T === void 0 ? !0 : T, z = e.imageSmoothingQuality, B = z === void 0 ? "low" : z, f = e.maxWidth, w = f === void 0 ? 1 / 0 : f, M = e.maxHeight, A = M === void 0 ? 1 / 0 : M, L = e.minWidth, $ = L === void 0 ? 0 : L, X = e.minHeight, H = X === void 0 ? 0 : X, _ = document.createElement("canvas"), R = _.getContext("2d"), F = Q({
    aspectRatio: g,
    width: w,
    height: A
  }), J = Q({
  ...
  return _.width = st(it), _.height = st(ct), R.fillStyle = E, R.fillRect(0, 0, it, ct), R.save(), R.translate(it / 2, ct / 2), R.rotate(p * Math.PI / 180), R.scale(h, u), R.imageSmoothingEnabled = x, R.imageSmoothingQuality = B, R.drawImage.apply(R, [a].concat(be(Nt.map(function(St) {
...
var Mi = {
  ...
  renderCanvas: function(t, i) {
    ...
    (e.width > e.maxWidth || e.width < e.minWidth) && (e.left = e.oldLeft), (e.height > e.maxHeight || e.height < e.minHeight) && (e.top = e.oldTop), e.width = Math.min(Math.max(e.width, e.minWidth), e.maxWidth), e.height = Math.min(Math.max(e.height, e.minHeight), e.maxHeight), this.limitCanvas(!1, !0), e.left = Math.min(Math.max(e.left, e.minLeft), e.maxLeft), e.top = Math.min(Math.max(e.top, e.minTop), e.maxTop), e.oldLeft = e.left, e.oldTop = e.top, Z(this.canvas, C({
      width: e.width,
      height: e.height
    }, gt({
      translateX: e.left,
  ...
  initCropBox: function() {
    ...
    e && (i.height * e > i.width ? r.height = r.width / e : r.width = r.height * e), this.cropBoxData = r, this.limitCropBox(!0, !0), r.width = Math.min(Math.max(r.width, r.minWidth), r.maxWidth), r.height = Math.min(Math.max(r.height, r.minHeight), r.maxHeight), r.width = Math.max(r.minWidth, r.width * n), r.height = Math.max(r.minHeight, r.height * n), r.left = i.left + (i.width - r.width) / 2, r.top = i.top + (i.height - r.height) / 2, r.oldLeft = r.left, r.oldTop = r.top, this.initialCropBoxData = C({}, r);
  },
  ...
  renderCropBox: function() {
    ...
    (e.width > e.maxWidth || e.width < e.minWidth) && (e.left = e.oldLeft), (e.height > e.maxHeight || e.height < e.minHeight) && (e.top = e.oldTop), e.width = Math.min(Math.max(e.width, e.minWidth), e.maxWidth), e.height = Math.min(Math.max(e.height, e.minHeight), e.maxHeight), this.limitCropBox(!1, !0), e.left = Math.min(Math.max(e.left, e.minLeft), e.maxLeft), e.top = Math.min(Math.max(e.top, e.minTop), e.maxTop), e.oldLeft = e.left, e.oldTop = e.top, t.movable && t.cropBoxMovable && vt(this.face, mt, e.width >= i.width && e.height >= i.height ? ye : qt), Z(this.cropBox, C({
      width: e.width,
      height: e.height
    }, gt({
      translateX: e.left,
  ...
  preview: function() {
    ...
    !this.cropped || this.disabled || (Z(this.viewBoxImage, C({
      ...
      var c = $t(h, Et), u = c.width, g = c.height, m = u, y = g, b = 1;
      n && (b = u / n, y = r * b), r && y > g && (b = g / r, m = n * b, y = g), Z(h, {
        width: m,
        height: y
      }), Z(h.getElementsByTagName("img")[0], C({
        width: o * b,
        height: s * b
      }, gt(C({
        translateX: -p * b,
  ...
  cropStart: function(t) {
    ...
    (v(i) && i !== 1 || v(e) && e !== 0 || t.ctrlKey))) {
      ...
      t.changedTouches ? O(t.changedTouches, function(s) {
        ...
        originalEvent: t,
        action: o
      }) !== !1 && (t.preventDefault(), this.action = o, this.cropping = !1, o === we && (this.cropping = !0, S(this.dragBox, Tt)));
    }
  },
  cropMove: function(t) {
    var i = this.action;
    if (!(this.disabled || !i)) {
      ...
      t.preventDefault(), ht(this.element, Ut, {
        originalEvent: t,
        action: i
      }) !== !1 && (t.changedTouches ? O(t.changedTouches, function(n) {
        C(e[n.identifier] || {}, Mt(n, !0));
      }) : C(e[t.pointerId || 0] || {}, Mt(t, !0)), this.change(t));
    }
  },
  cropEnd: function(t) {
    if (!this.disabled) {
      ...
      }) : delete e[t.pointerId || 0], i && (t.preventDefault(), Object.keys(e).length || (this.action = ""), this.cropping && (this.cropping = !1, nt(this.dragBox, Tt, this.cropped && this.options.modal)), ht(this.element, Xt, {
        originalEvent: t,
        action: i
      }));
    }
  ...
  change: function(t) {
    var i = this.options, e = this.canvasData, n = this.containerData, r = this.cropBoxData, o = this.pointers, s = this.action, p = i.aspectRatio, l = r.left, h = r.top, c = r.width, u = r.height, g = l + c, m = h + u, y = 0, b = 0, E = n.width, T = n.height, x = !0, z;
    ...
    switch (s) {
      case qt:
        ...
        break;
      case K:
        if (f.x >= 0 && (g >= E || p && (h <= b || m >= T))) {
          x = !1;
          break;
        }
        w(K), c += f.x, c < 0 && (s = tt, c = -c, l -= c), p && (u = c / p, h += (r.height - u) / 2);
        break;
      case q:
        ...
        break;
      case tt:
        if (f.x <= 0 && (l <= y || p && (h <= b || m >= T))) {
          x = !1;
          break;
        }
        w(tt), c -= f.x, l += f.x, c < 0 && (s = K, c = -c, l -= c), p && (u = c / p, h += (r.height - u) / 2);
        break;
      case rt:
      ...
      case pt:
        if (p) {
          ...
          w(q), w(K), f.x >= 0 ? g < E ? c += f.x : f.y <= 0 && h <= b && (x = !1) : c += f.x, f.y <= 0 ? h > b && (u -= f.y, h += f.y) : (u -= f.y, h += f.y);
        c < 0 && u < 0 ? (s = dt, u = -u, c = -c, h -= u, l -= c) : c < 0 ? (s = ut, c = -c, l -= c) : u < 0 && (s = ft, u = -u, h -= u);
        break;
      case ut:
        if (p) {
          if (f.y <= 0 && (h <= b || l <= y)) {
        ...
        c < 0 && u < 0 ? (s = ft, u = -u, c = -c, h -= u, l -= c) : c < 0 ? (s = pt, c = -c, l -= c) : u < 0 && (s = dt, u = -u, h -= u);
        break;
      case dt:
        if (p) {
          if (f.x <= 0 && (l <= y || m >= T)) {
          ...
          w(rt), w(tt), f.x <= 0 ? l > y ? (c -= f.x, l += f.x) : f.y >= 0 && m >= T && (x = !1) : (c -= f.x, l += f.x), f.y >= 0 ? m < T && (u += f.y) : u += f.y;
        c < 0 && u < 0 ? (s = pt, u = -u, c = -c, h -= u, l -= c) : c < 0 ? (s = ft, c = -c, l -= c) : u < 0 && (s = ut, u = -u, h -= u);
        break;
      case ft:
        if (p) {
          if (f.x >= 0 && (g >= E || m >= T)) {
          ...
          w(rt), w(K), f.x >= 0 ? g < E ? c += f.x : f.y >= 0 && m >= T && (x = !1) : c += f.x, f.y >= 0 ? m < T && (u += f.y) : u += f.y;
        c < 0 && u < 0 ? (s = ut, u = -u, c = -c, h -= u, l -= c) : c < 0 ? (s = dt, c = -c, l -= c) : u < 0 && (s = pt, u = -u, h -= u);
        break;
      case ye:
        this.move(f.x, f.y), x = !1;
        break;
      case xe:
        this.zoom(gi(o), t), x = !1;
        break;
      case we:
        if (!f.x || !f.y) {
          x = !1;
        ...
        z = Se(this.cropper), l = B.startX - z.left, h = B.startY - z.top, c = r.minWidth, u = r.minHeight, f.x > 0 ? s = f.y > 0 ? ft : pt : f.x < 0 && (l -= c, s = f.y > 0 ? dt : ut), f.y < 0 && (h -= u), this.cropped || (j(this.cropBox, I), this.cropped = !0, this.limited && this.limitCropBox(!0, !0));
        break;
    }
    x && (r.width = c, r.height = u, r.left = l, r.top = h, this.action = s, this.renderCropBox()), O(o, function(M) {
  ...
  crop: function() {
    return this.ready && !this.cropped && !this.disabled && (this.cropped = !0, this.limitCropBox(!0, !0), this.options.modal && S(this.dragBox, Tt), j(this.cropBox, I), this.setCropBoxData(this.initialCropBoxData)), this;
  },
  ...
  clear: function() {
    return this.cropped && !this.disabled && (C(this.cropBoxData, {
      ...
      width: 0,
      height: 0
    }), this.cropped = !1, this.renderCropBox(), this.limitCanvas(!0, !0), this.renderCanvas(), j(this.dragBox, Tt), S(this.cropBox, I)), this;
  },
  /**
  ...
  enable: function() {
    return this.ready && this.disabled && (this.disabled = !1, j(this.cropper, ae)), this;
  },
  // Disable (freeze) the cropper
  disable: function() {
    return this.ready && !this.disabled && (this.disabled = !0, S(this.cropper, ae)), this;
  },
  /**
  ...
  getCroppedCanvas: function() {
    ...
    var T = t.imageSmoothingEnabled, x = T === void 0 ? !0 : T, z = t.imageSmoothingQuality;
    E.imageSmoothingEnabled = x, z && (E.imageSmoothingQuality = z);
    var B = e.width, f = e.height, w = r, M = o, A, L, $, X, H, _;
    w <= -s || w > B ? (w = 0, A = 0, $ = 0, H = 0) : w <= 0 ? ($ = -w, w = 0, A = Math.min(B, s + w), H = A) : w <= B && ($ = 0, A = Math.min(s, B - w), H = A), A <= 0 || M <= -p || M > f ? (M = 0, L = 0, X = 0, _ = 0) : M <= 0 ? (X = -M, M = 0, L = Math.min(f, p + M), _ = L) : M <= f && (X = 0, L = Math.min(p, f - M), _ = L);
    var R = [w, M, A, L];
    if (H > 0 && _ > 0) {
      var F = m / s;
...
}, Bi = V.Cropper, Be = /* @__PURE__ */ function() {
  function a(t) {
    var i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    if (je(this, a), !t || !ri.test(t.tagName))
      throw new Error("The first argument is required and must be an <img> or <canvas> element.");
    this.element = t, this.options = C({}, fe, ot(i) && i), this.cropped = !1, this.disabled = !1, this.pointers = {}, this.ready = !1, this.reloading = !1, this.replaced = !1, this.sized = !1, this.sizing = !1, this.init();
  }
  return Ve(a, [{
    key: "init",
    value: function() {
    ...
    value: function(i) {
      ...
      if (i) {
        ...
        }, r.checkCrossOrigin && ge(i) && n.crossOrigin && (i = me(i)), o.open("GET", i, !0), o.responseType = "arraybuffer", o.withCredentials = n.crossOrigin === "use-credentials", o.send();
      }
    }
  }, {
    key: "read",
    ...
    value: function() {
      if (!(!this.sized || this.ready)) {
        ...
        o.innerHTML = oi;
        var s = o.querySelector(".".concat(D, "-container")), p = s.querySelector(".".concat(D, "-canvas")), l = s.querySelector(".".concat(D, "-drag-box")), h = s.querySelector(".".concat(D, "-crop-box")), c = h.querySelector(".".concat(D, "-face"));
        this.container = r, this.cropper = s, this.canvas = p, this.dragBox = l, this.cropBox = h, this.viewBox = s.querySelector(".".concat(D, "-view-box")), this.face = c, p.appendChild(n), S(i, I), r.insertBefore(s, i.nextSibling), j(n, re), this.initPreview(), this.bind(), e.initialAspectRatio = Math.max(0, e.initialAspectRatio) || NaN, e.aspectRatio = Math.max(0, e.aspectRatio) || NaN, e.viewMode = Math.max(0, Math.min(3, Math.round(e.viewMode))) || 0, S(h, I), e.guides || S(h.getElementsByClassName("".concat(D, "-dashed")), I), e.center || S(h.getElementsByClassName("".concat(D, "-center")), I), e.background && S(s, "".concat(D, "-bg")), e.highlight || S(c, Qe), e.cropBoxMovable && (S(c, Pt), vt(c, mt, qt)), e.cropBoxResizable || (S(h.getElementsByClassName("".concat(D, "-line")), I), S(h.getElementsByClassName("".concat(D, "-point")), I)), this.render(), this.ready = !0, this.setDragMode(e.dragMode), e.autoCrop && this.crop(), this.setData(e.data), k(e.ready) && P(i, ce, e.ready, {
          once: !0
        }), ht(i, ce);
      }
    }
...
const Ai = typeof window > "u" ? [String, Array] : [String, Array, Element, NodeList], _i = {
  render() {
...
const ki = ke({
  ...
  setup(a, t) {
    const { ui: i } = We(), { t: e } = Xe(), n = G(!1), r = G(), o = G(), s = G(!1), p = G(), l = G(), h = G(), c = G({
      x: 1,
      y: 1
    });
    function u() {
    ...
    const m = i.dialog.buildOnClosedBind(g), y = i.dialog.customClass, b = G({
      ...m,
      [y]: "fs-cropper-dialog",
...
const Ii = { class: "fs-cropper-dialog-wrap" }, zi = ["accept"], Li = { class: "fs-cropper-dialog__choose fs-cropper-dialog_left" }, Hi = { class: "fs-cropper-dialog__edit fs-cropper-dialog_left" }, Yi = { class: "fs-cropper-dialog__edit-area" }, Pi = { class: "tool-bar" }, Wi = { class: "fs-cropper-dialog__preview" }, Xi = /* @__PURE__ */ W("span", { class: "fs-cropper-dialog__preview-title" }, "预览", -1), Ui = /* @__PURE__ */ W("div", { class: "fs-cropper-dialog__preview-120 preview" }, null, -1), ji = { class: "dialog-footer" };
function Vi(a, t, i, e, n, r) {
  const o = Kt("fs-button"), s = Kt("vue-cropper");
  return Dt(), Rt(te(a.ui.dialog.name), Bt({
    ...
    default: At(() => [
      W("div", Ii, [
        ...
        _t(W("div", Hi, [
          ...
          W("div", Pi, [
            (Dt(), Rt(te(a.ui.buttonGroup.name), null, {
              default: At(() => [
                (Dt(!0), Le(He, null, Ye(a.computedButtons, (p, l) => (Dt(), Rt(o, Bt({ key: l }, p), null, 16))), 128))
              ]),
              _: 1
            }))
          ])
        ...
        W("div", Wi, [
          ...
          Ui,
          W("div", {
            class: Pe(["fs-cropper-dialog__preview-65 preview", { round: a._cropper.aspectRatio === 1 }])
          }, null, 2)
        ])
      ])
    ]),
...
const Zi = /* @__PURE__ */ Ue(ki, [["render", Vi]]);
export {
  Zi as default
};
//# sourceMappingURL=fs-cropper-effc19ff.mjs.map
