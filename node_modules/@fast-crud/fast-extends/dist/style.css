.fs-image-format{display:flex;margin:1px;flex-wrap:wrap;justify-content:center;align-items:center}.fs-image-format .fs-box{display:flex;align-items:center}.fs-image-format .fs-image-item{border:1px solid #eee;margin:0 1px;object-fit:fill;background-color:#eee;display:flex;justify-content:center;align-items:center}.fs-image-format .fs-image-slot{display:flex;align-items:center;justify-content:center;width:100%;height:100%}.fs-image-format .el-image-viewer__close{color:#fff}.fs-image-format .el-image__error,.fs-image-format .el-image__inner,.fs-image-format .el-image__placeholder{height:auto}.fs-image-format .el-image__wrapper{position:relative;display:flex;justify-content:center;align-items:center}.fs-phone-input{display:flex;align-items:center}.fs-phone-input .ant-select{width:120px;max-width:50%}.fs-phone-input .ant-select .ant-select-selector{border-top-right-radius:0;border-bottom-right-radius:0}.fs-phone-input .ant-input,.fs-phone-input .ant-input-affix-wrapper{border-bottom-left-radius:0;border-top-left-radius:0;border-left:0}.fs-phone-input .el-select{width:100px;max-width:50%}.fs-phone-input .el-select .el-input{border-right:0}.fs-phone-input .el-select .el-input__wrapper{border-right:0;border-top-right-radius:0;border-bottom-right-radius:0}.fs-phone-input .el-input{border-left:0}.fs-phone-input .el-input .el-input__wrapper{border-bottom-left-radius:0;border-top-left-radius:0;border-left:0}.fs-phone-input .n-select{width:100px;max-width:50%}.fs-phone-input .n-select .n-base-selection{border-top-right-radius:0;border-bottom-right-radius:0}.fs-phone-input .n-select .n-base-selection__border{border-right:0}.fs-phone-input .n-input{border-bottom-left-radius:0;border-top-left-radius:0}.fs-cropper-uploader .fs-box{display:flex;flex-wrap:wrap}.fs-cropper-uploader .el-image-viewer__close{color:#fff}.fs-cropper-uploader.is-disabled .image-list .image-item,.fs-cropper-uploader.is-disabled i{cursor:not-allowed}.fs-cropper-uploader .image-list{display:flex;justify-content:left;align-items:center;flex-wrap:wrap}.fs-cropper-uploader .image-list .image-item{width:100px;height:100px;display:flex;justify-content:center;align-items:center;background-color:#fbfdff;border:1px solid #c0ccda;border-radius:6px;position:relative;margin-right:8px;margin-bottom:8px;cursor:pointer;overflow:hidden}.fs-cropper-uploader .image-list .image-item.image-plus{border:1px dashed #c0ccda}.fs-cropper-uploader .image-list .image-item .cropper-uploader-icon{vertical-align:top;font-size:28px;color:#8c939d}.fs-cropper-uploader .image-list .image-item .image{width:100px}.fs-cropper-uploader .image-list .image-item .delete{border-radius:6px;position:absolute;width:100%;height:100%;left:0;top:0;cursor:default;text-align:center;color:#fff;opacity:0;font-size:20px;background-color:#000000e6;-webkit-transition:opacity .3s;transition:opacity .3s;justify-content:center;align-items:center;display:flex}.fs-cropper-uploader .image-list .image-item .delete:hover{opacity:.9}.fs-cropper-uploader .image-list .image-item .delete i{cursor:pointer}.fs-cropper-uploader .image-list .image-item .delete>*{margin:5px}.fs-cropper-uploader .image-list .image-item .status-uploading{border-radius:6px;position:absolute;width:100%;height:100%;left:0;top:0;cursor:default;text-align:center;color:#fff;opacity:1;font-size:20px;background-color:#00000080;-webkit-transition:opacity .3s;transition:opacity .3s;display:flex;justify-content:center;align-items:center}.fs-cropper-uploader .image-list .image-item .status-uploading .el-progress{width:70px;height:70px}.fs-cropper-uploader .image-list .image-item .status-uploading .el-progress .el-progress__text{color:#fff}.fs-cropper-uploader .image-list .image-item .status-done{position:absolute;right:-15px;top:-6px;width:40px;height:24px;background:#13ce66;text-align:center;-webkit-transform:rotate(45deg);transform:rotate(45deg);-webkit-box-shadow:0 0 1pc 1px rgba(0,0,0,.2);box-shadow:0 0 1pc 1px #0003;display:flex;justify-content:center;align-items:center}.fs-cropper-uploader .image-list .image-item .status-done .status-down-icon{font-size:12px;margin-top:11px;color:#fff;-webkit-transform:rotate(-45deg);transform:rotate(-45deg)}.fs-cropper-uploader .fs-cropper-preview{position:fixed;top:0;left:0;width:100%;height:100%;background-color:#b7b4b4b3;display:flex;justify-content:center;align-items:center;visibility:hidden;z-index:10000}.fs-cropper-uploader .fs-cropper-preview.open{visibility:visible}.fs-cropper-uploader .fs-cropper-preview .fs-cropper-preview-content{max-height:800px;max-width:800px}.fs-cropper-uploader .fs-cropper-preview .fs-cropper-preview-content img{max-height:800px;max-width:800px;object-fit:contain}/*!
 * Cropper.js v1.5.13
