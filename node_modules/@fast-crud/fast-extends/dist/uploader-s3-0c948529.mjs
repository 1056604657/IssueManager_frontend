import ln from "lodash-es";
import { b as Ko, u as Xo } from "./index-e3d54c21.mjs";
import Zo from "axios";
import { a as Vr } from "./_commonjsHelpers-2f131a27.mjs";
import "vue";
...
const ta = (e) => (t) => async (r) => {
  ...
  var n, s;
  try {
    const i = await e(r), { clientName: o, commandName: a, logger: c, dynamoDbDocumentClientOptions: u = {} } = t, { overrideInputFilterSensitiveLog: d, overrideOutputFilterSensitiveLog: h } = u, p = d ?? t.inputFilterSensitiveLog, y = h ?? t.outputFilterSensitiveLog, { $metadata: g, ...A } = i.output;
    ...
    const { clientName: o, commandName: a, logger: c, dynamoDbDocumentClientOptions: u = {} } = t, { overrideInputFilterSensitiveLog: d } = u, h = d ?? t.inputFilterSensitiveLog;
...
}), gn = "X-Amzn-Trace-Id", aa = "AWS_LAMBDA_FUNCTION_NAME", ca = "_X_AMZN_TRACE_ID", ua = (e) => (t) => async (r) => {
  const { request: n } = r;
...
}), ya = (e) => typeof e == "string" && e.indexOf("arn:") === 0 && e.split(":").length >= 6;
function ba() {
  return (e) => async (t) => {
...
const $a = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  __spreadArrays: Pa,
  __values: Or
}, Symbol.toStringTag, { value: "Module" })), ye = /* @__PURE__ */ Vr($a);
var jt = {}, We = {};
const Ha = (e) => {
  const t = [];
...
const Va = (e) => typeof TextEncoder == "function" ? qa(e) : Ha(e), Ga = (e) => typeof TextDecoder == "function" ? za(e) : ja(e), Wa = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  fromUtf8: Va,
  toUtf8: Ga
}, Symbol.toStringTag, { value: "Module" })), Ft = /* @__PURE__ */ Vr(Wa);
var mn;
function Ka() {
  if (mn)
    return We;
  mn = 1, Object.defineProperty(We, "__esModule", { value: !0 }), We.convertToBuffer = void 0;
...
function Xa() {
  if (yn)
    return Ke;
  yn = 1, Object.defineProperty(Ke, "__esModule", { value: !0 }), Ke.isEmptyData = void 0;
  function e(t) {
...
function Za() {
  if (bn)
    return Xe;
  bn = 1, Object.defineProperty(Xe, "__esModule", { value: !0 }), Xe.numToUint8 = void 0;
  function e(t) {
...
function Ya() {
  if (wn)
    return Ze;
  wn = 1, Object.defineProperty(Ze, "__esModule", { value: !0 }), Ze.uint32ArrayFrom = void 0;
  function e(t) {
    if (!Uint32Array.from) {
...
function Qa() {
  if (En)
    return Ye;
  En = 1, Object.defineProperty(Ye, "__esModule", { value: !0 }), Ye.AwsCrc32 = void 0;
    ...
    for (; n < t.byteLength; ) {
      ...
      switch (n += s, t.getUint8(n++)) {
        ...
        case 9:
          ...
          n += 16, r[i] = {
            type: ac,
            value: `${ce(c.subarray(0, 4))}-${ce(c.subarray(4, 6))}-${ce(c.subarray(6, 8))}-${ce(c.subarray(8, 10))}-${ce(c.subarray(10))}`
          };
          break;
        default:
...
const Cn = "boolean", ec = "byte", tc = "short", rc = "integer", nc = "long", sc = "binary", ic = "string", oc = "timestamp", ac = "uuid", cc = /^[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}$/, Bi = 4, Be = Bi * 2, Me = 4, uc = Be + Me * 2;
function dc({ byteLength: e, byteOffset: t, buffer: r }) {
  ...
  const i = n.getUint32(Bi, !1), o = n.getUint32(Be, !1), a = n.getUint32(e - Me, !1), c = new Gr.Crc32().update(new Uint8Array(r, t, Be));
  if (o !== c.digest())
    throw new Error(`The prelude checksum specified in the message (${o}) does not match the calculated CRC32 checksum (${c.digest()})`);
  if (c.update(new Uint8Array(r, t + Be, e - (Be + Me))), a !== c.digest())
...
class lc {
  constructor(t, r) {
    this.headerMarshaller = new Ri(t, r), this.messageBuffer = [], this.isEndOfStream = !1;
  }
  feed(t) {
...
const me = (e) => {
  ...
  return () => t;
}, xt = (e) => new TextEncoder().encode(e), He = (e) => typeof e == "string" ? xt(e) : ArrayBuffer.isView(e) ? new Uint8Array(e.buffer, e.byteOffset, e.byteLength / Uint8Array.BYTES_PER_ELEMENT) : new Uint8Array(e), It = (e) => new TextDecoder("utf-8").decode(e), mc = "X-Amz-Algorithm", yc = "X-Amz-Credential", _i = "X-Amz-Date", bc = "X-Amz-SignedHeaders", wc = "X-Amz-Expires", Ti = "X-Amz-Signature", ki = "X-Amz-Security-Token", Pi = "authorization", Ni = _i.toLowerCase(), Ac = "date", Ec = [Pi, Ni, Ac], xc = Ti.toLowerCase(), Fr = "x-amz-content-sha256", Sc = ki.toLowerCase(), vc = {
  authorization: !0,
  "cache-control": !0,
  connection: !0,
  expect: !0,
  ...
  "user-agent": !0,
  "x-amzn-trace-id": !0
}, Cc = /^proxy-/, Rc = /^sec-/, qt = "AWS4-HMAC-SHA256", Bc = "AWS4-HMAC-SHA256-PAYLOAD", _c = "UNSIGNED-PAYLOAD", Tc = 50, Oi = "aws4_request", kc = 60 * 60 * 24 * 7, St = {}, zt = [], Vt = (e, t, r) => `${e}/${t}/${r}/${Oi}`, Pc = async (e, t, r, n, s) => {
  ...
  return n;
}, Fe = (e) => encodeURIComponent(e).replace(/[!'()*]/g, Nc), Nc = (e) => `%${e.charCodeAt(0).toString(16).toUpperCase()}`, Oc = ({ query: e = {} }) => {
  const t = [], r = {};
...
}, Mi = (e) => typeof ArrayBuffer == "function" && e instanceof ArrayBuffer || Object.prototype.toString.call(e) === "[object ArrayBuffer]", Gt = async ({ headers: e, body: t }, r) => {
  ...
  for (const r of Object.keys(t))
    if (e === r.toLowerCase())
      return !0;
  return !1;
}, Fi = ({ headers: e, query: t, ...r }) => ({
  ...r,
  headers: { ...e },
  query: t ? Fc(t) : void 0
}), Fc = (e) => Object.keys(e).reduce((t, r) => {
  const n = e[r];
  return {
    ...t,
    [r]: Array.isArray(n) ? [...n] : n
  ...
  return e;
}, Dc = (e) => Uc(e).toISOString().replace(/\.\d{3}Z$/, "Z"), Uc = (e) => typeof e == "number" ? new Date(e * 1e3) : typeof e == "string" ? Number(e) ? new Date(Number(e) * 1e3) : new Date(e) : e;
class Ir {
  constructor({ applyChecksum: t, credentials: r, region: n, service: s, sha256: i, uriEscapePath: o = !0 }) {
    this.headerMarshaller = new Ri(It, xt), this.service = s, this.sha256 = i, this.uriEscapePath = o, this.applyChecksum = typeof t == "boolean" ? t : !0, this.regionProvider = me(n), this.credentialProvider = me(r);
  }
  async presign(t, r = {}) {
    const { signingDate: n = /* @__PURE__ */ new Date(), expiresIn: s = 3600, unsignableHeaders: i, unhoistableHeaders: o, signableHeaders: a, signingRegion: c, signingService: u } = r, d = await this.credentialProvider();
    this.validateResolvedCredentials(d);
    const h = c ?? await this.regionProvider(), { longDate: p, shortDate: y } = vt(n);
    if (s > kc)
  ...
  async signEvent({ headers: t, payload: r }, { signingDate: n = /* @__PURE__ */ new Date(), priorSignature: s, signingRegion: i, signingService: o }) {
    const a = i ?? await this.regionProvider(), { shortDate: c, longDate: u } = vt(n), d = Vt(c, a, o ?? this.service), h = await Gt({ headers: {}, body: r }, this.sha256), p = new this.sha256();
    p.update(t);
...
`);
  ...
  async signString(t, { signingDate: r = /* @__PURE__ */ new Date(), signingRegion: n, signingService: s } = {}) {
    ...
    const o = n ?? await this.regionProvider(), { shortDate: a } = vt(r), c = new this.sha256(await this.getSigningKey(i, o, a, s));
    return c.update(He(t)), ce(await c.digest());
  }
  async signRequest(t, { signingDate: r = /* @__PURE__ */ new Date(), signableHeaders: n, unsignableHeaders: s, signingRegion: i, signingService: o } = {}) {
    ...
    const c = i ?? await this.regionProvider(), u = _n(t), { longDate: d, shortDate: h } = vt(r), p = Vt(h, c, o ?? this.service);
    ...
    const g = Bn(u, s, n), A = await this.getSignature(d, p, this.getSigningKey(a, c, h, o), this.createCanonicalRequest(u, g, y));
...
const vt = (e) => {
...
}, Tn = (e) => Object.keys(e).sort().join(";"), Lc = 3e5, $c = (e) => {
  const t = e.credentials ? Hc(e.credentials) : e.credentialDefaultProvider(e), { signingEscapePath: r = !0, systemClockOffset: n = e.systemClockOffset || 0, sha256: s } = e;
  let i;
  return e.signer ? i = me(e.signer) : e.regionInfoProvider ? i = () => me(e.region)().then(async (o) => [
    ...
    const a = o.signingRegion, c = o.signingName;
    e.signingRegion = e.signingRegion || a, e.signingName = e.signingName || c || e.serviceId;
    const u = {
      ...e,
      credentials: t,
      region: e.signingRegion,
...
}, Hc = (e) => typeof e == "function" ? xi(e, (t) => t.expiration !== void 0 && t.expiration.getTime() - Date.now() < Lc, (t) => t.expiration !== void 0) : me(e), Ii = (e) => new Date(Date.now() + e), jc = (e, t) => Math.abs(Ii(t).getTime() - e) >= 3e5, kn = (e, t) => {
  const r = Date.parse(e);
  return jc(r, t) ? r - Date.now() : t;
}, qc = (e) => (t, r) => async function(n) {
  var u, d, h, p;
  ...
  return c && (e.systemClockOffset = kn(c, e.systemClockOffset)), a;
}, Pn = (e) => {
  var t, r;
...
const Xc = (e) => {
  ...
  $i(Di, "");
}, Hi = () => Li, Yc = new RegExp("^(?:25[0-5]|2[0-4]\\d|1\\d\\d|[1-9]\\d|\\d)(?:\\.(?:25[0-5]|2[0-4]\\d|1\\d\\d|[1-9]\\d|\\d)){3}$"), ji = (e) => Yc.test(e) || e.startsWith("[") && e.endsWith("]"), Et = "endpoints";
function Te(e) {
...
const Qc = new RegExp("^(?!.*-$)(?!-)[a-zA-Z0-9-]{1,63}$"), Wr = (e, t = !1) => {
  if (!t)
    return Qc.test(e);
  const r = e.split(".");
  for (const n of r)
...
}, Symbol.toStringTag, { value: "Module" })), tu = (e, t) => e === t, ru = (e) => {
  const t = e.split("."), r = [];
  for (const n of t) {
    const s = n.indexOf("[");
    if (s !== -1) {
...
const Wt = {
  ...
  if (a)
    return null;
  const c = o.slice(0, -1);
  if (!Object.values(wt).includes(c))
    return null;
  const u = ji(s), d = r.includes(`${n}:${Wt[c]}`) || typeof e == "string" && e.includes(`${n}:${Wt[c]}`), h = `${n}${d ? `:${Wt[c]}` : ""}`;
  return {
    scheme: c,
    authority: h,
    path: i,
...
}, ou = (e, t) => e === t, au = (e, t, r, n) => t >= r || e.length < r ? null : n ? e.substring(e.length - r, e.length - t) : e.substring(t, r), cu = (e) => encodeURIComponent(e).replace(/[!*'()]/g, (t) => `%${t.charCodeAt(0).toString(16).toUpperCase()}`), uu = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  aws: eu,
  booleanEquals: tu,
  getAttr: zi,
  ...
  substring: au,
  uriEncode: cu
}, Symbol.toStringTag, { value: "Module" })), Vi = (e, t) => {
  const r = [], n = {
    ...t.endpointParams,
    ...t.referenceRecord
  };
...
}, fu = (e, t) => Object.entries(e).reduce((r, [n, s]) => ({
  ...r,
  [n]: s.map((i) => {
...
}, Ki = (e, t) => Object.entries(e).reduce((r, [n, s]) => ({
  ...r,
  [n]: Wi(s, t)
}), {}), hu = (e, t) => {
  ...
  const c = Xi(i, { endpointParams: r, logger: n, referenceRecord: {} });
  if ((h = t.endpointParams) != null && h.Endpoint)
    try {
      const g = new URL(t.endpointParams.Endpoint), { protocol: A, port: B } = g;
      c.url.protocol = A, c.url.port = B;
    } catch {
    }
  return (y = (p = t.logger) == null ? void 0 : p.debug) == null || y.call(p, `${Et} Resolved endpoint: ${Te(c)}`), c;
}, On = "user-agent", Kt = "x-amz-user-agent", Mn = " ", Xt = "/", bu = /[^\!\$\%\&\'\*\+\-\.\^\_\`\|\~\d\w]/g, wu = /[^\!\$\%\&\'\*\+\-\.\^\_\`\|\~\d\w\#]/g, Fn = "-", Au = (e) => (t, r) => async (n) => {
  var p, y;
  const { request: s } = n;
  if (!ue.isInstance(s))
    return t(n);
  const { headers: i } = s, o = ((p = r == null ? void 0 : r.userAgent) == null ? void 0 : p.map(Zt)) || [], a = (await e.defaultUserAgentProvider()).map(Zt), c = ((y = e == null ? void 0 : e.customUserAgent) == null ? void 0 : y.map(Zt)) || [], u = Hi(), d = (u ? [u] : []).concat([...a, ...o, ...c]).join(Mn), h = [
...
const Su = !1, vu = !1, Zi = (e) => typeof e == "string" && (e.startsWith("fips-") || e.endsWith("-fips")), Dn = (e) => Zi(e) ? ["fips-aws-global", "aws-fips"].includes(e) ? "us-east-1" : e.replace(/fips-(dkr-|prod-)?|-fips/, "") : e, Cu = (e) => {
  ...
  return {
    ...
    useFipsEndpoint: async () => {
      ...
      return Zi(n) ? !0 : typeof r != "function" ? Promise.resolve(!!r) : r();
    }
  };
}, Ru = (e) => ({
  ...e,
...
const _u = {
  ...
  if (typeof e.Bucket == "string" && (e.Bucket = t.replace(/#/g, encodeURIComponent("#")).replace(/\?/g, encodeURIComponent("?"))), Fu(t)) {
    ...
    (!Mu(t) || t.indexOf(".") !== -1 && !String(e.Endpoint).startsWith("http:") || t.toLowerCase() !== t || t.length < 3) && (e.ForcePathStyle = !0);
  return e.DisableMultiRegionAccessPoints && (e.disableMultiRegionAccessPoints = !0, e.DisableMRAP = !0), e;
}, Pu = /^[a-z0-9][a-z0-9\.\-]{1,61}[a-z0-9]$/, Nu = /(\d+\.){3}\d+/, Ou = /\.\./, Mu = (e) => Pu.test(e) && !Nu.test(e) && !Ou.test(e), Fu = (e) => {
  const [t, r, n, s, i, o] = e.split(":"), a = t === "arn" && e.split(":").length >= 6, c = [t, r, n, i, o].filter(Boolean).length === 5;
  if (a && !c)
...
}, $u = (e) => typeof e == "object" ? "url" in e ? kt(e.url) : e : kt(e), Hu = ({ config: e, instructions: t }) => (r, n) => async (s) => {
  var a, c;
...
const Gu = {
  ...
  const t = e.tls ?? !0, { endpoint: r } = e, n = r != null ? async () => $u(await me(r)()) : void 0;
  return {
    ...e,
    endpoint: n,
    tls: t,
    isCustomEndpoint: !!r,
    useDualstackEndpoint: me(e.useDualstackEndpoint ?? !1),
    useFipsEndpoint: me(e.useFipsEndpoint ?? !1)
  };
};
var qe;
(function(e) {
...
], Yu = ["TimeoutError", "RequestTimeout", "RequestTimeoutException"], Qu = [500, 502, 503, 504], Ju = ["ECONNRESET", "ECONNREFUSED", "EPIPE", "ETIMEDOUT"], Qi = (e) => {
  var t, r;
  return ((t = e.$metadata) == null ? void 0 : t.httpStatusCode) === 429 || Zu.includes(e.name) || ((r = e.$retryable) == null ? void 0 : r.throttling) == !0;
}, Ji = (e) => {
  var t;
...
const Dr = 100, eo = 20 * 1e3, rd = 500, Ln = 500, nd = 5, sd = 10, id = 1, od = "amz-sdk-invocation-id", ad = "amz-sdk-request", cd = () => {
  let e = Dr;
  return {
...
}, $n = ({ retryDelay: e, retryCount: t, retryCost: r }) => ({
  getRetryCount: () => t,
...
const fd = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;
function hd(e) {
...
const md = (e) => e instanceof Error ? e : e instanceof Object ? Object.assign(new Error(), e) : typeof e == "string" ? new Error(e) : new Error(`AWS SDK error wrapper for ${e}`), yd = (e) => {
  ...
  if (wd(s)) {
    s = s;
    let o = await s.acquireInitialRetryToken(r.partition_id), a = new Error(), c = 0, u = 0;
    const { request: d } = n;
    for (ue.isInstance(d) && (d.headers[od] = gd()); ; )
      try {
        ue.isInstance(d) && (d.headers[ad] = `attempt=${c + 1}; max=${i}`);
        const { response: h, output: p } = await t(n);
        return s.recordSuccess(o), p.$metadata.attempts = c + 1, p.$metadata.totalRetryDelay = u, { response: h, output: p };
      } catch (h) {
        const p = Ad(h);
        a = md(h);
        try {
...
}, wd = (e) => typeof e.acquireInitialRetryToken < "u" && typeof e.refreshRetryTokenForRetry < "u" && typeof e.recordSuccess < "u", Ad = (e) => {
  const t = {
    errorType: Ed(e)
  }, r = vd(e.$response);
  return r && (t.retryAfterHint = r), t;
}, Ed = (e) => Qi(e) ? "THROTTLING" : Ji(e) ? "TRANSIENT" : ed(e) ? "SERVER_ERROR" : "CLIENT_ERROR", xd = {
...
const Pt = () => {
  ...
  const r = /* @__PURE__ */ new Set(), n = (d) => d.sort((h, p) => Hn[p.step] - Hn[h.step] || jn[p.priority || "normal"] - jn[h.priority || "normal"]), s = (d) => {
    let h = !1;
    const p = (y) => y.name && y.name === d ? (h = !0, r.delete(d), !1) : !0;
    return e = e.filter(p), t = t.filter(p), h;
  }, i = (d) => {
    let h = !1;
    const p = (y) => y.middleware === d ? (h = !0, y.name && r.delete(y.name), !1) : !0;
    return e = e.filter(p), t = t.filter(p), h;
  }, o = (d) => (e.forEach((h) => {
    ...
    removeByTag: (d) => {
      ...
      const p = (y) => {
        ...
        return g && g.includes(d) ? (A && r.delete(A), h = !0, !1) : !0;
      };
      return e = e.filter(p), t = t.filter(p), h;
    },
    concat: (d) => {
    ...
    applyToStack: o,
    identify: () => c(!0).map((d) => d.name + ": " + (d.tags || []).join(",")),
    resolve: (d, h) => {
      for (const p of c().map((y) => y.middleware).reverse())
        d = p(d, h);
      return d;
    }
  };
...
class Od {
  ...
  async handle(t, { abortSignal: r } = {}) {
    ...
    const { port: a, method: c } = t, u = `${t.protocol}//${o}${t.hostname}${a ? `:${a}` : ""}${s}`, h = {
      body: c === "GET" || c === "HEAD" ? void 0 : t.body,
...
const ro = (e) => typeof Blob == "function" && e instanceof Blob ? Md(e) : Fd(e);
async function Md(e) {
...
const qn = "The stream has already been transformed.", Dd = (e) => {
  var s, i;
  if (!zn(e) && !Vn(e)) {
...
}, zn = (e) => typeof Blob == "function" && e instanceof Blob, Vn = (e) => typeof ReadableStream == "function" && e instanceof ReadableStream, no = async (e = new Uint8Array(), t) => {
...
const bt = "***SensitiveInformation***", Ld = (e) => {
  switch (e) {
    case "true":
      return !0;
    case "false":
...
}, $d = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], Hd = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
function jd(e) {
  const t = e.getUTCFullYear(), r = e.getUTCMonth(), n = e.getUTCDay(), s = e.getUTCDate(), i = e.getUTCHours(), o = e.getUTCMinutes(), a = e.getUTCSeconds(), c = s < 10 ? `0${s}` : `${s}`, u = i < 10 ? `0${i}` : `${i}`, d = o < 10 ? `0${o}` : `${o}`, h = a < 10 ? `0${a}` : `${a}`;
  return `${$d[n]}, ${c} ${Hd[r]} ${t} ${u}:${d}:${h} GMT`;
}
class Qr extends Error {
  constructor(t) {
    super(t.message), Object.setPrototypeOf(this, Qr.prototype), this.name = t.name, this.$fault = t.$fault, this.$metadata = t.$metadata;
  }
}
const qd = (e, t = {}) => {
...
}, zd = ({ output: e, parsedBody: t, exceptionCtor: r, errorCode: n }) => {
  ...
  throw qd(o, t);
}, Vd = (e) => ({ output: t, parsedBody: r, errorCode: n }) => {
...
const Kd = (e, t, r) => Nt(e, Object.entries(r).reduce((n, [s, i]) => (Array.isArray(i) ? n[s] = i : typeof i == "function" ? n[s] = [t, i()] : n[s] = [t, i], n), {})), Xd = (e, t, r, n) => {
  if (t !== null) {
    let o = r[n];
    typeof o == "function" && (o = [, o]);
    const [a = Zd, c = Yd, u = n] = o;
...
}, Zd = (e) => e != null, Yd = (e) => e, Wn = (e, t, r, n, s, i) => {
...
}), Jd = "@aws-sdk/client-s3", el = "AWS SDK for JavaScript S3 Client for Node.js, Browser and React Native", tl = "3.383.0", rl = {
...
}, nl = "./dist-cjs/index.js", sl = "./dist-types/index.d.ts", il = "./dist-es/index.js", ol = !1, al = {
...
}, gl = "https://github.com/aws/aws-sdk-js-v3/tree/main/clients/client-s3", ml = {
  type: "git",
...
function oo() {
  if (Kn)
    return et;
  Kn = 1, Object.defineProperty(et, "__esModule", { value: !0 }), et.isEmptyData = void 0;
  function e(t) {
    return typeof t == "string" ? t.length === 0 : t.byteLength === 0;
  }
...
const Al = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  locateWindow: wl
}, Symbol.toStringTag, { value: "Module" })), Ge = /* @__PURE__ */ Vr(Al);
var Zn;
function co() {
  if (Zn)
    return Je;
  Zn = 1, Object.defineProperty(Je, "__esModule", { value: !0 }), Je.Sha1 = void 0;
  var e = oo(), t = ao(), r = Ft, n = Ge, s = (
    ...
    function() {
      ...
      return a.prototype.update = function(c) {
        var u = this;
        (0, e.isEmptyData)(c) || (this.operation = this.operation.then(function(d) {
        ...
        return this.operation.then(function(c) {
          return new Promise(function(u, d) {
            c.onerror = function() {
              ...
              c.result && u(new Uint8Array(c.result)), d(new Error("Error encountered finalizing hash"));
            }, c.finish();
          });
        });
  ...
  function i(a) {
    return new Promise(function(c, u) {
      var d = (0, n.locateWindow)().msCrypto.subtle.importKey("raw", o(a), t.SHA_1_HMAC_ALGO, !1, ["sign"]);
      d.oncomplete = function() {
        d.result && c(d.result), u(new Error("ImportKey completed without importing key."));
      }, d.onerror = function() {
...
function uo() {
  if (Yn)
    return tt;
  Yn = 1, Object.defineProperty(tt, "__esModule", { value: !0 }), tt.Sha1 = void 0;
...
function El() {
  if (Qn)
    return he;
  Qn = 1, Object.defineProperty(he, "__esModule", { value: !0 }), he.supportsZeroByteGCM = he.supportsSubtleCrypto = he.supportsSecureRandom = he.supportsWebCrypto = void 0;
  var e = ye, t = [
    "decrypt",
    "digest",
    "encrypt",
...
var er = {}, tr = {}, es;
function xl() {
  return es || (es = 1, Object.defineProperty(tr, "__esModule", { value: !0 })), tr;
}
var rr = {}, ts;
function Sl() {
  return ts || (ts = 1, Object.defineProperty(rr, "__esModule", { value: !0 })), rr;
}
var nr = {}, rs;
function vl() {
  return rs || (rs = 1, Object.defineProperty(nr, "__esModule", { value: !0 })), nr;
}
var sr = {}, ns;
function Cl() {
  return ns || (ns = 1, Object.defineProperty(sr, "__esModule", { value: !0 })), sr;
}
var rt = {}, ss;
function Rl() {
  if (ss)
    return rt;
  ss = 1, Object.defineProperty(rt, "__esModule", { value: !0 }), rt.isMsWindow = void 0;
  var e = [
    "decrypt",
    "digest",
    "encrypt",
...
function Bl() {
  if (os)
    return Qe;
  os = 1, Object.defineProperty(Qe, "__esModule", { value: !0 }), Qe.Sha1 = void 0;
...
function _l() {
  if (as)
    return it;
  as = 1, Object.defineProperty(it, "__esModule", { value: !0 }), it.isEmptyData = void 0;
  function e(t) {
    return typeof t == "string" ? t.length === 0 : t.byteLength === 0;
  }
...
function go() {
  if (us)
    return st;
  us = 1, Object.defineProperty(st, "__esModule", { value: !0 }), st.Sha256 = void 0;
  ...
  function i(a) {
    return new Promise(function(c, u) {
      var d = (0, n.locateWindow)().msCrypto.subtle.importKey("raw", o(a), t.SHA_256_HMAC_ALGO, !1, ["sign"]);
      d.oncomplete = function() {
        d.result && c(d.result), u(new Error("ImportKey completed without importing key."));
      }, d.onerror = function() {
        u(new Error("ImportKey failed to import key."));
...
function mo() {
  if (ds)
    return ot;
  ds = 1, Object.defineProperty(ot, "__esModule", { value: !0 }), ot.Sha256 = void 0;
...
var or = {}, at = {}, ae = {}, ls;
function yo() {
  return ls || (ls = 1, Object.defineProperty(ae, "__esModule", { value: !0 }), ae.MAX_HASHABLE_LENGTH = ae.INIT = ae.KEY = ae.DIGEST_LENGTH = ae.BLOCK_SIZE = void 0, ae.BLOCK_SIZE = 64, ae.DIGEST_LENGTH = 32, ae.KEY = new Uint32Array([
    1116352408,
    1899447441,
    3049323471,
    3921009573,
...
function Tl() {
  if (fs)
    return ct;
  fs = 1, Object.defineProperty(ct, "__esModule", { value: !0 }), ct.RawSha256 = void 0;
  var e = yo(), t = (
    /** @class */
    function() {
      function r() {
      ...
      return r.prototype.update = function(n) {
        ...
        for (var n = this, s = n.buffer, i = n.state, o = i[0], a = i[1], c = i[2], u = i[3], d = i[4], h = i[5], p = i[6], y = i[7], g = 0; g < e.BLOCK_SIZE; g++) {
          if (g < 16)
          ...
          var se = (((d >>> 6 | d << 26) ^ (d >>> 11 | d << 21) ^ (d >>> 25 | d << 7)) + (d & h ^ ~d & p) | 0) + (y + (e.KEY[g] + this.temp[g] | 0) | 0) | 0, Le = ((o >>> 2 | o << 30) ^ (o >>> 13 | o << 19) ^ (o >>> 22 | o << 10)) + (o & a ^ o & c ^ a & c) | 0;
          y = p, p = h, h = d, d = u + se | 0, u = c, c = a, a = o, o = se + Le | 0;
        }
        i[0] += o, i[1] += a, i[2] += c, i[3] += u, i[4] += d, i[5] += h, i[6] += p, i[7] += y;
      }, r;
    }()
  );
...
function kl() {
  if (hs)
    return at;
  hs = 1, Object.defineProperty(at, "__esModule", { value: !0 }), at.Sha256 = void 0;
...
function Nl() {
  if (gs)
    return nt;
  gs = 1, Object.defineProperty(nt, "__esModule", { value: !0 }), nt.Sha256 = void 0;
  var e = go(), t = mo(), r = Pl(), n = lo(), s = fo(), i = Ge, o = Pe(), a = (
    ...
    function() {
      ...
      return c.prototype.update = function(u, d) {
...
class m {
  ...
  static compareVersions(t, r, n = !1) {
    const s = m.getVersionPrecision(t), i = m.getVersionPrecision(r);
    let o = Math.max(s, i), a = 0;
    const c = m.map([t, r], (u) => {
      const d = o - m.getVersionPrecision(u), h = u + new Array(d + 1).join(".0");
      return m.map(h.split("."), (p) => new Array(20 - p.length).join("0") + p).reverse();
    });
...
class ms {
  ...
  satisfies(t) {
    ...
    if (Object.keys(t).forEach((a) => {
      ...
      const a = Object.keys(r), c = m.find(a, (d) => this.isOS(d));
      if (c) {
    ...
    if (i > 0) {
      const a = Object.keys(s), c = m.find(a, (u) => this.isBrowser(u, !0));
      if (c !== void 0)
...
const Ul = ({ serviceId: e, clientVersion: t }) => async () => {
  var s, i, o, a, c;
    ...
    for (; ; ) {
      ...
      for (; h < d; ) {
        if (!n) {
          ...
          if (s.set(c.slice(h, h + g), r), r += g, h += g, r < 4)
            break;
...
const Vl = (e) => typeof ReadableStream == "function" && e instanceof ReadableStream, Gl = (e) => new zl(e);
function Wl(e, t, r = 1024 * 1024) {
  return new Promise((n, s) => {
    ...
    i.addEventListener("load", (u) => {
      ...
      t(new Uint8Array(d)), a += d.byteLength, c();
    }), c();
  });
}
const Kl = async function(t, r) {
  const n = new t();
  return await Wl(r, (s) => {
    n.update(s);
  }), n.digest();
}, Xl = (e) => () => Promise.reject(e), ve = 64, Zl = 16, Yl = [1732584193, 4023233417, 2562383102, 271733878];
class Ql {
  constructor() {
    this.reset();
  }
  ...
  async digest() {
    if (!this.finished) {
      ...
      for (let o = this.bufferLength; o < ve - 8; o++)
        r.setUint8(o, 0);
      r.setUint32(ve - 8, i >>> 0, !0), r.setUint32(ve - 4, Math.floor(i / 4294967296), !0), this.hashBuffer(), this.finished = !0;
    }
  ...
  hashBuffer() {
    ...
    n = Y(n, s, i, o, t.getUint32(0, !0), 7, 3614090360), o = Y(o, n, s, i, t.getUint32(4, !0), 12, 3905402710), i = Y(i, o, n, s, t.getUint32(8, !0), 17, 606105819), s = Y(s, i, o, n, t.getUint32(12, !0), 22, 3250441966), n = Y(n, s, i, o, t.getUint32(16, !0), 7, 4118548399), o = Y(o, n, s, i, t.getUint32(20, !0), 12, 1200080426), i = Y(i, o, n, s, t.getUint32(24, !0), 17, 2821735955), s = Y(s, i, o, n, t.getUint32(28, !0), 22, 4249261313), n = Y(n, s, i, o, t.getUint32(32, !0), 7, 1770035416), o = Y(o, n, s, i, t.getUint32(36, !0), 12, 2336552879), i = Y(i, o, n, s, t.getUint32(40, !0), 17, 4294925233), s = Y(s, i, o, n, t.getUint32(44, !0), 22, 2304563134), n = Y(n, s, i, o, t.getUint32(48, !0), 7, 1804603682), o = Y(o, n, s, i, t.getUint32(52, !0), 12, 4254626195), i = Y(i, o, n, s, t.getUint32(56, !0), 17, 2792965006), s = Y(s, i, o, n, t.getUint32(60, !0), 22, 1236535329), n = Q(n, s, i, o, t.getUint32(4, !0), 5, 4129170786), o = Q(o, n, s, i, t.getUint32(24, !0), 9, 3225465664), i = Q(i, o, n, s, t.getUint32(44, !0), 14, 643717713), s = Q(s, i, o, n, t.getUint32(0, !0), 20, 3921069994), n = Q(n, s, i, o, t.getUint32(20, !0), 5, 3593408605), o = Q(o, n, s, i, t.getUint32(40, !0), 9, 38016083), i = Q(i, o, n, s, t.getUint32(60, !0), 14, 3634488961), s = Q(s, i, o, n, t.getUint32(16, !0), 20, 3889429448), n = Q(n, s, i, o, t.getUint32(36, !0), 5, 568446438), o = Q(o, n, s, i, t.getUint32(56, !0), 9, 3275163606), i = Q(i, o, n, s, t.getUint32(12, !0), 14, 4107603335), s = Q(s, i, o, n, t.getUint32(32, !0), 20, 1163531501), n = Q(n, s, i, o, t.getUint32(52, !0), 5, 2850285829), o = Q(o, n, s, i, t.getUint32(8, !0), 9, 4243563512), i = Q(i, o, n, s, t.getUint32(28, !0), 14, 1735328473), s = Q(s, i, o, n, t.getUint32(48, !0), 20, 2368359562), n = J(n, s, i, o, t.getUint32(20, !0), 4, 4294588738), o = J(o, n, s, i, t.getUint32(32, !0), 11, 2272392833), i = J(i, o, n, s, t.getUint32(44, !0), 16, 1839030562), s = J(s, i, o, n, t.getUint32(56, !0), 23, 4259657740), n = J(n, s, i, o, t.getUint32(4, !0), 4, 2763975236), o = J(o, n, s, i, t.getUint32(16, !0), 11, 1272893353), i = J(i, o, n, s, t.getUint32(28, !0), 16, 4139469664), s = J(s, i, o, n, t.getUint32(40, !0), 23, 3200236656), n = J(n, s, i, o, t.getUint32(52, !0), 4, 681279174), o = J(o, n, s, i, t.getUint32(0, !0), 11, 3936430074), i = J(i, o, n, s, t.getUint32(12, !0), 16, 3572445317), s = J(s, i, o, n, t.getUint32(24, !0), 23, 76029189), n = J(n, s, i, o, t.getUint32(36, !0), 4, 3654602809), o = J(o, n, s, i, t.getUint32(48, !0), 11, 3873151461), i = J(i, o, n, s, t.getUint32(60, !0), 16, 530742520), s = J(s, i, o, n, t.getUint32(8, !0), 23, 3299628645), n = ee(n, s, i, o, t.getUint32(0, !0), 6, 4096336452), o = ee(o, n, s, i, t.getUint32(28, !0), 10, 1126891415), i = ee(i, o, n, s, t.getUint32(56, !0), 15, 2878612391), s = ee(s, i, o, n, t.getUint32(20, !0), 21, 4237533241), n = ee(n, s, i, o, t.getUint32(48, !0), 6, 1700485571), o = ee(o, n, s, i, t.getUint32(12, !0), 10, 2399980690), i = ee(i, o, n, s, t.getUint32(40, !0), 15, 4293915773), s = ee(s, i, o, n, t.getUint32(4, !0), 21, 2240044497), n = ee(n, s, i, o, t.getUint32(32, !0), 6, 1873313359), o = ee(o, n, s, i, t.getUint32(60, !0), 10, 4264355552), i = ee(i, o, n, s, t.getUint32(24, !0), 15, 2734768916), s = ee(s, i, o, n, t.getUint32(52, !0), 21, 1309151649), n = ee(n, s, i, o, t.getUint32(16, !0), 6, 4149444226), o = ee(o, n, s, i, t.getUint32(44, !0), 10, 3174756917), i = ee(i, o, n, s, t.getUint32(8, !0), 15, 718787259), s = ee(s, i, o, n, t.getUint32(36, !0), 21, 3951481745), r[0] = n + r[0] & 4294967295, r[1] = s + r[1] & 4294967295, r[2] = i + r[2] & 4294967295, r[3] = o + r[3] & 4294967295;
  }
  reset() {
    this.state = Uint32Array.from(Yl), this.buffer = new DataView(new ArrayBuffer(ve)), this.bufferLength = 0, this.bytesHashed = 0, this.finished = !1;
  }
}
...
class rf {
  ...
  getSigv4aSigner() {
    if (!this.sigv4aSigner) {
      let t;
      try {
        if (t = typeof require == "function" && require("@aws-sdk/signature-v4-crt").CrtSignerV4, typeof t != "function")
          throw new Error();
      } catch (r) {
...
}), ff = ["in-region", "cross-region", "mobile", "standard", "legacy"], hf = ({ defaultsMode: e } = {}) => xi(async () => {
...
class mf extends Rd {
  constructor(t) {
    const r = gf(t), n = Qd(r), s = Cu(n), i = Ku(s), o = yd(i), a = o, c = $c(a), u = ma(c), d = Gc(u), h = Ru(d);
...
(function(e) {
  const t = ":A-Za-z_\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", r = t + "\\-.\\d\\u00B7\\u0300-\\u036F\\u203F-\\u2040", n = "[" + t + "][" + r + "]*", s = new RegExp("^" + n + "$"), i = function(a, c) {
    ...
    for (; d; ) {
      const h = [];
      h.startIndex = c.lastIndex - d[0].length;
      const p = d.length;
      for (let y = 0; y < p; y++)
        h.push(d[y]);
      u.push(h), d = c.exec(a);
  ...
  e.isExist = function(a) {
    ...
    if (c) {
      const d = Object.keys(c), h = d.length;
      for (let p = 0; p < h; p++)
        u === "strict" ? a[d[p]] = [c[d[p]]] : a[d[p]] = c[d[p]];
    }
...
` && e[i] !== "\r"; i++)
          c += e[i];
        if (c = c.trim(), c[c.length - 1] === "/" && (c = c.substring(0, c.length - 1), i--), !Cf(c)) {
          let h;
          return c.trim().length === 0 ? h = "Invalid space after '<'." : h = "Tag '" + c + "' is an invalid name.", j("InvalidTag", h, ie(e, i));
        }
        const u = Af(e, i);
        if (u === !1)
          return j("InvalidAttr", "Attributes for '" + c + "' have open quote.", ie(e, i));
        let d = u.value;
        if (i = u.index, d[d.length - 1] === "/") {
          ...
          if (u.tagClosed) {
            if (d.trim().length > 0)
              return j("InvalidTag", "Closing tag '" + c + "' can't have attributes or invalid starting.", ie(e, o));
            {
              const h = r.pop();
              if (c !== h.tagName) {
            ...
            return j("InvalidTag", "Closing tag '" + c + "' doesn't have proper closing.", ie(e, i));
        else {
          const h = hi(d, t);
          if (h !== !0)
...
const Ef = new RegExp(`(\\s*)([^\\s=]+)(\\s*=)?(\\s*(['"])(([\\s\\S])*?)\\5)?`, "g");
function hi(e, t) {
...
var Uf = kf;
const Lf = /^[-+]?0x[a-fA-F0-9]+$/, $f = /^([\-\+])?(0*)(\.[0-9]+([eE]\-?[0-9]+)?|[0-9]+(\.[0-9]+([eE]\-?[0-9]+)?)?)$/;
...
const Yf = new RegExp(`([^\\s=]+)\\s*(=\\s*(['"])([\\s\\S]*?)\\3)?`, "gm");
function Qf(e, t, r) {
    ...
    for (let o = 0; o < s; o++) {
      ...
      if (a.length)
        if (this.options.transformAttributeName && (u = this.options.transformAttributeName(u)), u === "__proto__" && (u = "#__proto__"), c !== void 0) {
          ...
          const d = this.options.attributeValueProcessor(a, c, t);
          d == null ? i[u] = c : typeof d != typeof c || d !== c ? i[u] = d : i[u] = qr(
            c,
  ...
  for (let i = 0; i < e.length; i++)
    if (e[i] === "<")
      if (e[i + 1] === "/") {
        ...
        const a = Ie(e, "]]>", i, "CDATA is not closed.") - 2, c = e.substring(i + 9, a);
        ...
        let a = jr(e, i, this.options.removeNSPrefix), c = a.tagName, u = a.tagExp, d = a.attrExpPresent, h = a.closeIndex;
        ...
        if (p && this.options.unpairedTags.indexOf(p.tagname) !== -1 && (r = this.tagsNodeStack.pop(), s = s.substring(0, s.lastIndexOf("."))), c !== t.tagname && (s += s ? "." + c : c), this.isItStopNode(this.options.stopNodes, s, c)) {
          ...
          const g = new ht(c);
          c !== u && d && (g[":@"] = this.buildAttributesMap(u, s, c)), y && (y = this.parseTextData(y, c, s, !0, d, !0, !0)), s = s.substr(0, s.lastIndexOf(".")), g.add(this.options.textNodeName, y), this.addChild(r, g, s);
        } else {
          if (u.length > 0 && u.lastIndexOf("/") === u.length - 1) {
            ...
            const y = new ht(c);
            c !== u && d && (y[":@"] = this.buildAttributesMap(u, s, c)), this.addChild(r, y, s), s = s.substr(0, s.lastIndexOf("."));
          } else {
            const y = new ht(c);
            this.tagsNodeStack.push(r), c !== u && d && (y[":@"] = this.buildAttributesMap(u, s, c)), this.addChild(r, y, s), r = y;
          }
          n = "", i = h;
        }
      }
...
function qr(e, t, r) {
  if (t && typeof e == "string") {
    const n = e.trim();
    return n === "true" ? !0 : n === "false" ? !1 : Gf(e, r);
  } else
  ...
  for (let i = 0; i < e.length; i++) {
    ...
    if (r === void 0 ? c = a : c = r + "." + a, a === t.textNodeName)
      ...
      if (o[a]) {
        let u = Lo(o[a], t, c);
        const d = dh(u, t);
        o[":@"] ? uh(u, o[":@"], c, t) : Object.keys(u).length === 1 && u[t.textNodeName] !== void 0 && !t.alwaysCreateTextNode ? u = u[t.textNodeName] : Object.keys(u).length === 0 && (t.alwaysCreateTextNode ? u[t.textNodeName] = "" : u = ""), s[a] !== void 0 && s.hasOwnProperty(a) ? (Array.isArray(s[a]) || (s[a] = [s[a]]), s[a].push(u)) : t.isArray(a, c, d) ? s[a] = [u] : s[a] = u;
      }
    }
  }
...
Uo.prettify = ah;
const { buildOptions: lh } = an, fh = oh, { prettify: hh } = Uo, ph = sn;
let gh = class {
  constructor(t) {
...
function $o(e, t, r, n) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    if (r.length === 0 ? u = c : u = `${r}.${c}`, c === t.textNodeName) {
      let g = a[c];
      Ah(u, t) || (g = t.tagValueProcessor(c, g), g = Ho(g, t)), i && (s += n), s += g, i = !1;
      continue;
      ...
      const g = pi(a[":@"], t), A = c === "?xml" ? "" : n;
      let B = a[c][0][t.textNodeName];
      B = B.length !== 0 ? " " + B : "", s += A + `<${c}${B}${g}?>`, i = !0;
      continue;
    }
    let d = n;
    d !== "" && (d += t.indentBy);
    const h = pi(a[":@"], t), p = n + `<${c}${h}`, y = $o(a[c], t, u, d);
    t.unpairedTags.indexOf(c) !== -1 ? t.suppressUnpairedNode ? s += p + ">" : s += p + "/>" : (!y || y.length === 0) && t.suppressEmptyNode ? s += p + "/>" : y && y.endsWith(">") ? s += p + `>${y}${n}</${c}>` : (s += p + ">", y && n !== "" && (y.includes("/>") || y.includes("</")) ? s += n + t.indentBy + y + n : s += y, s += `</${c}>`), i = !0;
  }
  return s;
}
function wh(e) {
...
function pi(e, t) {
  ...
  if (e && !t.ignoreAttributes)
    for (let n in e) {
      ...
      s = Ho(s, t), s === !0 && t.suppressBooleanAttributes ? r += ` ${n.substr(t.attributeNamePrefix.length)}` : r += ` ${n.substr(t.attributeNamePrefix.length)}="${s}"`;
    }
  return r;
}
function Ah(e, t) {
...
const Nh = (e) => ({
  ...
  a = Wn(a, e, "Bucket", () => e.Bucket, "{Bucket}", !1), a = Wn(a, e, "Key", () => e.Key, "{Key+}", !0);
  const c = Nt({
    "x-id": [, "PutObject"]
  });
  let u;
  ...
  extendedRequestId: e.headers["x-amz-id-2"],
  cfId: e.headers["x-amz-cf-id"]
}), Lh = (e, t) => no(e, t).then((r) => t.utf8Encoder(r)), pt = (e) => e != null && e !== "" && (!Object.getOwnPropertyNames(e).includes("length") || e.length != 0) && (!Object.getOwnPropertyNames(e).includes("size") || e.size != 0), $h = (e, t) => Lh(e, t).then((r) => {
  if (r.length) {
...
function qh(e) {
  return (t) => async (r) => {
    ...
    for (const i of s) {
      const o = n[i.target];
      if (o) {
        const a = ArrayBuffer.isView(o) ? new Uint8Array(o.buffer, o.byteOffset, o.byteLength) : typeof o == "string" ? e.utf8Decoder(o) : new Uint8Array(o), c = e.base64Encoder(a), u = new e.md5();
        u.update(a), n = {
          ...n,
          [i.target]: c,
...
const zr = [
  ...
  Z.SHA1,
  Z.SHA256
], Wh = (e, { requestChecksumRequired: t, requestAlgorithmMember: r }) => {
  if (!r || !e[r])
  ...
  return n;
}, jo = (e) => e === Z.MD5 ? "content-md5" : `x-amz-checksum-${e.toLowerCase()}`, Kh = (e, t) => {
  const r = e.toLowerCase();
  for (const n of Object.keys(t))
    if (r === n.toLowerCase())
      return !0;
  return !1;
}, qo = (e) => e !== void 0 && typeof e != "string" && !ArrayBuffer.isView(e) && !Mi(e);
var kr = {}, gt = {}, Ai;
function Xh() {
  if (Ai)
    return gt;
  Ai = 1, Object.defineProperty(gt, "__esModule", { value: !0 }), gt.AwsCrc32c = void 0;
...
const Vo = (e, t) => ({
...
}, Yh = async (e, { streamHasher: t, checksumAlgorithmFn: r, base64Encoder: n }) => {
  ...
  return t;
}, Jh = async (e, { config: t, responseAlgorithms: r }) => {
  ...
  if (!ue.isInstance(n.request))
    return r(n);
  const { request: s } = n, { body: i, headers: o } = s, { base64Encoder: a, streamHasher: c } = e, { input: u, requestChecksumRequired: d, requestAlgorithmMember: h } = t, p = Wh(u, {
...
class dn extends Ud {
  ...
  resolveMiddleware(t, r, n) {
    this.middlewareStack.use(Vu(r, this.serialize, this.deserialize)), this.middlewareStack.use(Wu(r, dn.getEndpointParameterInstructions())), this.middlewareStack.use(ga()), this.middlewareStack.use(Vh(r)), this.middlewareStack.use(rp(r, {
      input: this.input,
      requestAlgorithmMember: "ChecksumAlgorithm",
      requestChecksumRequired: !1
    }));
    const s = t.concat(this.middlewareStack), { logger: i } = r, c = {
      logger: i,
      clientName: "S3Client",
    ...
    return s.resolve((d) => u.handle(d.request, n || {}), c);
  }
  serialize(t, r) {
    return Mh(t, r);
  }
...
async function mp(e) {
  const { getConfig: t } = Xo(), r = t("s3"), n = e.options, s = ln.merge(ln.cloneDeep(r), n);
...
//# sourceMappingURL=uploader-s3-0c948529.mjs.map
