...
// node_modules/@fast-crud/fast-extends/dist/fs-file-uploader-771d3c4d.mjs
var be = defineComponent({
  ...
  setup(n, u) {
    const { ui: o } = w(), { t: p } = tt(), s = ref([]), v = ref(), c = ref(), M = computed(() => n.getFileName || ((e) => {
      if (typeof e != "string")
    ...
    const L = async (e) => {
      ...
      !e.url && !e.preview && e.originFileObj && (e.preview = await ee(e.originFileObj)), q.value = e.url || e.preview, O.value = true;
    };
    function ie() {
      const e = {
        customRequest: T,
        ...
        customRequest: (t) => {
          ...
          T({
            ...
            onSuccess: async (l) => {
              ...
              l.url = await n.buildUrl(a), lodash_default_default.merge(i, l), V[i.id] = {
                ...l,
                fsRes: l
              }, t.onFinish(i);
            },
...
var Ce = Cd(be, [["render", Ue]]);
export {
  Ce as default
};
//# sourceMappingURL=fs-file-uploader-771d3c4d-3JENE4EV.js.map
