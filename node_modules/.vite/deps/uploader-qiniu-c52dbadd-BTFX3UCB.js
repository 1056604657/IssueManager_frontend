...
// node_modules/@fast-crud/fast-extends/dist/uploader-qiniu-c52dbadd.mjs
...
async function f({ file: n, fileName: o, onProgress: a, options: e }) {
  const t = await w9(n, o, e), r = await d(n, o, t, e);
...
async function T(n) {
  const { getConfig: o } = _9(), a = o("qiniu"), e = n.options, t = lodash_default_default.merge(lodash_default_default.cloneDeep(a), e);
...
//# sourceMappingURL=uploader-qiniu-c52dbadd-BTFX3UCB.js.map
