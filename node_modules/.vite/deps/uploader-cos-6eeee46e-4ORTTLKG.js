        ...
        function(modules) {
          ...
          "./lib/beacon.min.js": (
            ...
            function(module2, exports2, __webpack_require__) {
              ...
              !function(t, e) {
                "object" == (false ? void 0 : _typeof(exports2)) && "undefined" != typeof module2 ? module2.exports = e() : true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = e, __WEBPACK_AMD_DEFINE_RESULT__ = typeof __WEBPACK_AMD_DEFINE_FACTORY__ === "function" ? __WEBPACK_AMD_DEFINE_FACTORY__.call(exports2, __webpack_require__, exports2, module2) : __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__ !== void 0 && (module2.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : void 0;
              }(this, function() {
                "use strict";
                ...
                }(), m = "session_storage_key", w2 = function() {
                  function t(t2, e, n2) {
                ...
                function N(t, e) {
                  ...
                  var n2 = t.url, r2 = t.query, o2 = void 0 === r2 ? {} : r2, i2 = t.hash, s2 = n2.split("#"), a2 = s2[0], u2 = s2[1], c2 = void 0 === u2 ? "" : u2, l2 = a2.split("?")[0], p2 = [], h3 = U(i2 || c2, e), f3 = _P(_P({}, function(t2) {
                  ...
                  return Object.keys(f3).forEach(function(t2) {
                    var n3 = U(t2, e), r3 = U(f3[t2], e);
                    null !== n3 && null !== r3 && p2.push(n3 + "=" + r3);
                  }), l2 + (p2.length ? "?" + p2.join("&") : "") + (h3 ? "#" + h3 : "");
                }
                function j(t, e) {
                  return new Promise(function(n2, r2) {
                ...
                function K(t) {
                  return A(this, void 0, void 0, function() {
                    var e, n2, r2, o2, i2, s2, a2, u2, c2, l2, p2, h3, f3, d2, v2, g2, y3;
                      ...
                      switch (m2.label) {
                        ...
                        case 2:
                          ...
                          return i2.url = function(t2, e2) {
                            ...
                            url: s2,
                            query: u2
                          }) : s2, h3 = [], a2 && !i2.signal && (v2 = new Promise(function(t2) {
                            f3 = setTimeout(function() {
                              t2(new Error("timeout"));
                            }, a2);
                          }), h3.push(v2), d2 = new AbortController(), i2.signal = d2.signal), h3.push(fetch(p2, i2).catch(function(t2) {
                            return t2;
                          })), [4, Promise.race(h3)];
                        case 3:
                          return g2 = m2.sent(), f3 && clearTimeout(f3), [4, r2.response.traverse(g2)];
                        case 4:
                          if ((y3 = m2.sent()) instanceof Error)
                            throw null == d2 || d2.abort(), y3;
                          return [2, y3];
                      }
                    });
                  });
                ...
                return function(n2) {
                      ...
                      e.storage.setItem(s, Date.now().toString()), e.network.post(e.uploadUrl || e.strategy.getUploadUrl(), t2.data).then(function(r5) {
                        ...
                        100 == (null === (o3 = null == r5 ? void 0 : r5.data) || void 0 === o3 ? void 0 : o3.result) ? e.delayTime = 1e3 * r5.data.delayTime : e.delayTime = 0, n3 && n3(t2.data), t2.data.events.forEach(function(t3) {
                          e.store.removeEvent(t3).then(function() {
                            e.removeSendingId(f2(t3.mapValue));
                          });
                        }), e.doCustomCycleTask();
                      }).catch(function(n4) {
                        ...
                        o3.forEach(function(t3) {
                          i3 && -1 != i3.indexOf(f2(t3)) && e.store.insertEvent(t3, function(t4, n5) {
                            t4 && e.errorReport.reportError("604", "insertEvent fail!");
                          }), e.removeSendingId(f2(t3));
                        }), e.monitorUploadFailed();
                      });
                    };
                    var r3, o2, i2 = b();
                    return e.isUnderIE8 = i2 > 0 && i2 < 8, e.isUnderIE8 || (e.isUnderIE = i2 > 0, t.needInitQimei && S2(t.appkey, function(t2) {
                      e.qimei36 = t2.q36;
                    }), e.network = new F(t), e.storage = new G(t.appkey), e.initCommonInfo(t), e.store = new _(t.appkey, e.storage), e.errorReport = new g(e.config, e.commonInfo, "web", e.network), e.strategy = new y2(null == t.needQueryConfig || t.needQueryConfig, e.config, e.commonInfo, e.storage, e.network), e.logidStartTime = e.storage.getItem(z), e.logidStartTime || (e.logidStartTime = Date.now().toString(), e.storage.setItem(z, e.logidStartTime)), r3 = e.logidStartTime, o2 = Date.now() - Number.parseFloat(r3), Math.floor(o2 / 864e5) >= 365 && e.storage.clear(), e.initSession(t), e.onDirectUserAction("rqd_js_init", {}), setTimeout(function() {
                  ...
                  return function(e, n3) {
                    ...
                    var e = 18e5;
                    t.sessionDuration && t.sessionDuration > 3e4 && (e = t.sessionDuration), this.beaconSession = new w2(this.storage, e, this);
                ...
                var CryptoJS = CryptoJS || function(g, l) {
                  var e = {}, d = e.lib = {}, m = function m2() {
                    ...
                    parse: function parse(a) {
                      for (var c = a.length, b2 = [], f2 = 0; f2 < c; f2 += 2)
                        b2[f2 >>> 3] |= parseInt(a.substr(f2, 2), 16) << 24 - 4 * (f2 % 8);
                    ...
                    parse: function parse(a) {
                      for (var c = a.length, b2 = [], f2 = 0; f2 < c; f2++)
                        b2[f2 >>> 2] |= (a.charCodeAt(f2) & 255) << 24 - 8 * (f2 % 4);
                ...
                (function() {
                  ...
                  g.algo.HMAC = g.lib.Base.extend({
                    init: function init(e, d) {
                      ...
                      d.clamp();
                      for (var p = this._oKey = d.clone(), b = this._iKey = d.clone(), n = p.words, j = b.words, h2 = 0; h2 < g2; h2++)
                        n[h2] ^= 1549556828, j[h2] ^= 909522486;
          ...
          "./src/tracker.js": (
            ...
            function(module2, exports2, __webpack_require__) {
              ...
              var getBeacon = function getBeacon2(delay) {
                if (!beacon) {
                  var BeaconAction = __webpack_require__(
                    /*! ../lib/beacon.min */
                    "./lib/beacon.min.js"
                  );
...
// node_modules/@fast-crud/fast-extends/dist/uploader-cos-6eeee46e.mjs
...
async function h({ file: e, fileName: n, onProgress: c, options: r }) {
  const t = await w9(e, n, r), i = r, a = w(i);
...
async function S(e) {
  const { getConfig: n } = _9(), c = n("cos"), r = e.options, t = lodash_default_default.merge(lodash_default_default.cloneDeep(c), r);
...
//# sourceMappingURL=uploader-cos-6eeee46e-4ORTTLKG.js.map
